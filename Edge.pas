...
begin
  ...
  LEnvironmentOptions := TCoreWebView2EnvironmentOptions.Create;
  LEnvironmentOptions.Set_AdditionalBrowserArguments(PChar(FAdditionalBrowserArguments));

  //LEnvironmentOptions.Set_AdditionalBrowserArguments('--disable-web-security');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--use-angle=vulkan');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-unsafe-webgpu');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-features=WebAssemblySimd,WebAssemblyThreads,ExperimentalWebAssembly,WebAssemblyBaseline,WebAssemblyLazyCompilation,WebAssemblyTiering');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--disable-robustness');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-gpu-rasterization --force-gpu-rasterization --enable-zero-copy');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-validation-layers');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-aggressive-domstorage-flushing');

  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-compute-shaders');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--max-vertex-attributes=30');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-dawn-features=disable_robustness,expose_wgsl_experimental_features');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--use-webgpu-compatibility-mode');


  LEnvironmentOptions.Set_AdditionalBrowserArguments('--edge-video-super-resolution');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--allow-insecure-localhost');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--allow-file-access-from-files');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-plugins');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-parallel-downloading');
  LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-features=WebContentsForceDark');


  //LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-video-super-resolution');
  //LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-features=MicrosoftVideoSuperResolution');
  //LEnvironmentOptions.Set_AdditionalBrowserArguments('--enable-dawn-features=disable_robustness');

  //LEnvironmentOptions.Set_AllowSingleSignOnUsingOSPrimaryAccount(1);
